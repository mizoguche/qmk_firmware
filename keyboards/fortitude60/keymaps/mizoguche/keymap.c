 ...
 * `-------------+------+------+------+------+------+------+------+------+------+------+-------------'
 *               |  ESC | Lower|  Alt | GUI  |Space |Enter | GUI  | Alt  | Raise|  ESC |
 *               `---------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_LBRC,    KC_RBRC, KC_N,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
                  KC_ESC,   LOWER, KC_LALT,  KC_LGUI, KC_SPC,     KC_ENT,  KC_RGUI,  KC_RALT, RAISE,   KC_ESC\
),
...
[_LOWER] = LAYOUT( \
  ...
  KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_BSLS, \
  KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, _______, KC_F12,S(KC_NUHS),S(KC_NUBS),_______, _______, _______,\
...
[_RAISE] = LAYOUT( \
  ...
  KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_EQL,  KC_BSLS, \
  KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, _______,  KC_F12,  KC_NUHS, KC_NUBS, _______, _______, _______, \
                    _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______\
),
